...
while True:
    ...
    if len(faces) >= 1:
        cv.putText(frame, 'Number of Faces: ' + str(len(faces)), (20,20), cv.FONT_HERSHEY_COMPLEX, 1.0, (0,255,0), 2)
        ...
        for (ex, ey, ew, eh) in left_eye:
            ...
            if pred == 'Closed':
                cv.rectangle(left_face, (ex,ey), (ex+ew,ey+eh), (0,0,255), 2)
            else:
                cv.rectangle(left_face, (ex,ey), (ex+ew,ey+eh), (0,255,0), 2)
        ...
        for (ex, ey, ew, eh) in right_eye:
            ...
            if pred == 'Closed':
                cv.rectangle(right_face, (ex,ey), (ex+ew,ey+eh), (0,0,255), 2)
            else:
                cv.rectangle(right_face, (ex,ey), (ex+ew,ey+eh), (0,255,0), 2)
